...
<html lang="en">
	...
	<body>
		<header>
			  ...
			  <div class="container">
				...
				<div class="navbar-collapse  collapse">
				  <ul class="nav navbar-nav navbar-right scroll">
					...
					<li class="active"><a href="<?php echo base_url(); ?>Faq/openAll"><h3><i class="fa fa-pencil-sqaure"></i> Manage Answers</h3></a>
					</li>
					 <li class="dropdown">
			...
			<div class="container center-align question"> <?php
				if($result) 			
				{
					foreach ($result as $row) {
						?>
						<h5><?php echo $row['name'] ?> :
						<b><?php echo $row['question'] ?> </b></h5>
						<div class="well">
							<h5> <?php echo $row['answer']  ?> </h5>						
						 					</div> 
				
		<a href="<?php echo base_url(); ?>Faq/viewOne/<?php echo $row['Id'] ?>" class="btn btn-info center-align round">Edit</a>
		<a href="<?php echo base_url(); ?>Faq/removeAnswer/<?php echo $row['Id'] ?>" class="btn btn-success center-align round">Remove Answer</a>
		<a href="<?php echo base_url(); ?>Faq/deleteAnswer/<?php echo $row['Id'] ?>"  class="btn btn-warning center-align round">Delete</a>
		<br>
		<br>
		<?php   }
		 }
		 else 
		 {echo "<h4>You haven't answered any questions yet</h4>";  }
 ?>
