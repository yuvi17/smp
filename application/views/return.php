...
<!-- Header Starts -->
	...
	<br>
	<br>
	<div class="container" style="width:500px; padding:50px; background:#00897b; border-radius:5px;">
		<h3 class="text-center">
			Your Question has been recorded. You can see the answer to your question by our members on this section.
			Any question deemed inappropriate will be deleted by us.
			<br>
			Regards, Team SMP BIT Mesra
			<br>
			<br>
			<a class="btn btn-info" href="<?php echo base_url();?>Question/showFaq">Go To FAQ</a>
		</h3>
	</div>
