...
<html lang="en">
	...
	<div class="message container center">
		...
		<h3 class="text-center"> Your Password has been Successfully Changed. </h3>
	</div>
	<br>
	<br>
	<div class="container" style="width:450px; padding:5px;">
		<a href="<?php echo base_url(); ?>AdminPanel/index" class="btn btn-info pull-left"><h3><i class="fa fa-home"></i> Home</h3></a>
		<a href="<?php echo base_url(); ?>AdminPanel/logout" class="btn btn-info pull-right"><h3><i class="fa fa-sign-out"></i> Log Out</h3></a>
		<br>
		<br>
	</div>	
